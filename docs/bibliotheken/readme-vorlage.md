...
| `## Installation` | npm-Workspace im Repository und Installation im Anwendungsrepository (`npm install @flowaudit/<paket>`), Peer-Abhängigkeiten, CSS-Import | `npm install <name>` |
