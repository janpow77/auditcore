...
| [`auditcore_invoicesynth`](../../packages/auditcore_invoicesynth) | 0.1.1 | Synthetic German/Austrian invoice images with Donut ground truth, manifests and evaluation | `auditcore_invoicegenerator==0.2.1`; Extras: `render`, `train` | neu |
