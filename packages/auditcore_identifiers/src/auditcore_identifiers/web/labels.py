...
KIND_LABELS: Mapping[IdentifierKind, tuple[str, str, bool]] = MappingProxyType({
    IdentifierKind.IBAN: (
        "IBAN", "Internationale Kontonummer (ISO 13616): Register, Länge, BBAN-Aufbau, "
        "Prüfziffer MOD 97-10; nationale Kontoprüfziffern werden nicht geprüft.", False),
    IdentifierKind.BIC: (
        "BIC", "Geschäftskennung von Instituten (ISO 9362): 8 oder 11 Zeichen, Länderkennzeichen.",
        False),
    IdentifierKind.VAT_ID: (
        "USt-IdNr.", "Umsatzsteuer-Identifikationsnummer: Formate aller EU-Staaten, Prüfziffer "
        "für DE und AT; ohne Länderpräfix nur mit angegebenem Land.", True),
    IdentifierKind.TAX_ID: (
        "Steuer-ID", "Steuerliche Identifikationsnummer (§ 139b AO): 11 Ziffern, "
        "Ziffernverteilung, Prüfziffer.", False),
    IdentifierKind.TAX_NUMBER: (
        "Steuernummer", "Steuernummer: Landesformat (10/11 Ziffern) oder 13-stelliges "
        "Bundesformat; nur grobe Formatprüfung ohne Prüfziffer.", False),
    IdentifierKind.LEI: (
        "LEI", "Legal Entity Identifier (ISO 17442): 20 Zeichen, Prüfziffer MOD 97-10.", False),
    IdentifierKind.REGISTER_NUMBER: (
        "Handelsregisternummer", "Registerart (HRA, HRB, GnR, PR, VR) und Nummer; nur Format.",
        False),
})
