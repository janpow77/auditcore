...
ARTIFACT = "auditcore_market_indicators"
CASES: dict[str, tuple[str, list[str]]] = {
    "T-31": (
        "Gleiche Reihe, Version, Parameter und Profil ergeben dasselbe Ergebnis; "
        "method_reference nennt Bibliothek, Methode, Parameter und Profil-Fingerabdruck",
        [
            "tests/test_reproducibility.py",
            "tests/test_indicators.py::test_method_reference_names_library_method_parameters_and_profile",
        ],
    ),
    "T-38": (
        "Laufzeit nur Standardbibliothek und eigenes Paket, polars nur im optionalen Adapter, "
        "keine I/O, kein globaler Zufall",
        ["tests/test_architecture.py"],
    ),
    "F-15-methods": (
        "Benannte, quellengebundene Indikatorprofile ohne stilles Standardprofil; "
        "Legacy-Verhalten an gepinnte krypto-Quellen gebunden und nachgespielt",
        [
            "tests/test_profiles.py",
            "tests/test_legacy_replay.py::test_fixture_is_the_pinned_source_and_environment",
            "tests/test_legacy_replay.py::test_fixture_documents_the_legacy_semantics_that_profiles_keep",
        ],
    ),
}
REQUIREMENTS = {
