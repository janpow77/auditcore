...
def reject_edpb_fields(given: Mapping[str, Any], rules: RuleProfile) -> None:
...
def parse_dossier(raw: Mapping[str, Any], rules: RuleProfile) -> dict[str, str]:
...
def parse_measure_status(raw: Mapping[str, Any], rules: RuleProfile) -> dict[str, dict[str, str]]:
...
def parse_action_plan(raw: Sequence[Any], rules: RuleProfile) -> tuple[dict[str, str], ...]:
