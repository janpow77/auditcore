...
1. `backend/requirements.txt`:
   ...
   ```text
   auditcore_price_sources @ https://github.com/janpow77/auditcore/releases/download/v0.4.2/auditcore_price_sources-0.1.3-py3-none-any.whl#sha256=<aus Release>
   ```
