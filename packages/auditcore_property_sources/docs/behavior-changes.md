...
| PS-C05 | `Verfahren` trägt `lat`/`lon` aus der Nominatim-Geokodierung. | `ZvgNotice` ohne Koordinaten; Geokodierung bleibt beim Consumer. | Eigener Dienst mit Nutzungsrichtlinie (Lastenheft: Self-Hosting), Geo-Domäne. |
