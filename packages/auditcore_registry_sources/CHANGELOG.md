...
Keine Befunde. Legacy-Varianten: Modul `legacy`, Profil `flowinvoice.sanctions_network`, `parse_xml_list(..., dates="legacy")`.

## 0.2.3 – 2026-09-26 – Paketstand für Release v0.4.2

Keine Verhaltensänderung. README mit den Installationsangaben aus Release v0.4.1. Pins: `auditcore_common==0.2.0`, `auditcore_harvest==0.1.3`, `auditcore_entity_matching==0.2.4`.
