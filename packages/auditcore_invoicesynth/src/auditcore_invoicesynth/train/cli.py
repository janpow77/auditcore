...
from auditcore_invoicesynth.train.profiles import PROFILES, GpuInfo, choose_topology
...
def main(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        if args.backend == "mock":
            ...
            from auditcore_invoicesynth.train.torch_backend import (
                TorchDonutBackend,
                build_tiny_base,
            )
