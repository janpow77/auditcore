...
CASES: dict[str, tuple[str, list[str]]] = {
    ...
    "F-15-methods": (
        ...
        [
            "tests/test_sizes.py::test_both_mus_methods_are_named_and_neither_is_default",
            "tests/test_sizes.py::test_sa_c01_method_conflict_is_visible",
            "tests/test_legacy_replay.py::test_fixture_is_bound_to_pinned_sources",
        ],
    ),
}
REQUIREMENTS = {
