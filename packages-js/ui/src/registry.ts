 ...
 */
export const ELEMENTS: readonly ElementDefinition[] = [tableElement, samplingElement, benfordElement, kanbanBoardElement, kanbanBoardListElement, screeningReviewElement, riskFlagsElement, synopsisElement, comparisonsElement, vvtElement, dsfaElement, geoMapElement, reportExportElement]
