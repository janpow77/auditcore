...
import { ENRICHMENT_CASE, EXPORT_CASE, fixtureModel, INFO_CASE, SEARCH_CASE, SHORTCUT_CASE, XML_CASE, type DialogCase } from '../../../bpmn-flowaudit/test/parity/cases-dialogs'
import { ISSUE_CASE, KEY_FILTER_CASE } from '../../../bpmn-flowaudit/test/parity/cases-views'
