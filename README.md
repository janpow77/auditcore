...
| [`auditcore_llm_client`](packages/auditcore_llm_client) | 0.1.1 | Client für den ai-router und das Flow-Agent-Inferenz-Gateway – Chat, Streaming, Embeddings, Reranking, OCR und Health – mit App-Profilen, Schwärzung, Wiederholungen und Circuit-Breaker. | keine; Extras: `http` | neu, gegen charakterisierte Verträge |
